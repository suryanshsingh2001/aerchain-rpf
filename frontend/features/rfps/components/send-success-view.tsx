...
export function SendSuccessView({ rfpId, vendorCount }: SendSuccessViewProps) {
  return (
    <div className="flex-1 flex items-center justify-center p-6">
      <Card className="max-w-lg w-full overflow-hidden">
        <div className="bg-linear-to-br from-emerald-500/20 to-emerald-500/5 p-8 text-center">
